      ...
      <div className="bg-black h-screen w-screen absolute overflow-hidden">
        <div className="text-white">
          ...
          <div className="flex items-center justify-center flex-col ">
            <Link
              to="/login"
              className="bg-white text-black text-xl font-semibold border rounded-lg w-[60%] text-center p-3 mt-2"
            >
              Continue
            </Link>
          </div>
          <p className="text-white text-xs mt-32 ml-1">
            *Not literally anywhere. See rideon.com/cities for availability.
          </p>
        </div>
      </div>
    </div>
