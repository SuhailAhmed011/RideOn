...
const RidePopUpPannel = (props) => {
  ...
  return (
   ...
   <h3 className=" ml-2 text-lg font-bold">New Ride For You!!</h3>
   ...
   }} className='w-full bg-[#f9ca24] rounded-xl text-white font-medium p-2 mt-5'>Accept</button>
   <button onClick={()=>{
    props.setRidePopUpPannel(false)
}} className='w-full bg-[#ff3838] rounded-xl text-white font-medium p-2 mt-5'>Ignore</button>
   </div>
 </div>
  )
}
